    ...
    <header id="header">
        <div class="container">
            <div class="logo-gnb-area">
                <!-- logo -->
                <h1 class="brand">
                    <a href="/pulmuonePro/index.jsp" title="메인으로 가기">
                        <img src="/pulmuonePro/resources/images/contents/account_logo.png" alt="풀무원녹즙">
                    </a>
                </h1>
                <!-- // logo -->
            ...
            <div class="member-search-area">
                    ...
                    <div class="head-util-area">
                        ...
                        <a href="/cart/daily">
                            <div class="counter " data-cart-size>1</div>
